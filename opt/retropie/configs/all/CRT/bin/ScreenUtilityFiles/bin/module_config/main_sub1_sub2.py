...
class main_sub1_sub2(object):
    ...
    def opt2(self, p_iJoy = None, p_iLine = None):
        ...
        if p_iJoy & CRT_OK:
            ...
            if new == False: ini_set(CRT_UTILITY_FILE, "integer_scale", "false")
            elif new == True: ini_set(CRT_UTILITY_FILE, "integer_scale", "true")
    ...
    def opt11(self, p_iJoy = None, p_iLine = None):
        ...
        if p_iJoy & CRT_OK:
            ...
            value = self.m_lLines[p_iLine]['value']
            new = explore_list(p_iJoy, value, list)
            if new == False: ini_set(CRT_UTILITY_FILE, "scummvm_arc", "false")
            elif new == True: ini_set(CRT_UTILITY_FILE, "scummvm_arc", "true")
            self.m_lLines[p_iLine].update({'value': new})
