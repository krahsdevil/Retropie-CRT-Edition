...
RETROPIE_RUNCOMMAND_LOG = os.path.join(TMP_LAUNCHER_PATH, "runcommand.log")
...
CRT_OLED_PORT = 18862
CRT_OLED_PATH = os.path.join(CRT_MODULES_PATH, "module_display")
CRT_OLED_CORE_FILE = "oled.py"
CRT_OLED_CORE_PATH = os.path.join(CRT_OLED_PATH, CRT_OLED_CORE_FILE)
CRT_OLED_SRV_FILE = "oled.service"
CRT_OLED_SRV_PATH = os.path.join(CRT_OLED_PATH, CRT_OLED_SRV_FILE)
CRT_OLED_STOP_CORE_FILE = "oled_stop.py"
CRT_OLED_STOP_CORE_PATH = os.path.join(CRT_OLED_PATH, CRT_OLED_STOP_CORE_FILE)
CRT_OLED_STOP_SRV_FILE = "oled_stop.service"
CRT_OLED_STOP_SRV_PATH = os.path.join(CRT_OLED_PATH, CRT_OLED_STOP_SRV_FILE)
